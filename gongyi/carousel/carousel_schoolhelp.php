...
<div class="container-fluid">
    ...
    <div class="carouseltitle">
        <span class="glyphicon glyphicon-list"></span><b>精准助学</b><span style="color: #888;font-size: 5px;margin-left: 30px">注意:图片像素请不小于180x240,大小不超过1M</span>
    </div>
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <!--                    <td>活动报道</td>-->
            <!--                    <td class="hidden-sm hidden-xs"><img src="../../image/galler/gallery0.jpg" alt="活动报道轮播图1" width="150px" height="100px" style="border:1px solid red"></td>-->
            ...
            for($i=1;$i<=mysqli_num_rows($result);$i++){
                ...
                echo '<td class="hidden-sm hidden-xs"><img src="'.$row[3].'" alt="精准助学图" width="120px" height="160px" style="border:1px solid red"></td>';
                echo '<td class="hidden-sm hidden-xs"><textarea style="width: 100%" rows="3" name="textarea" id="textarea" placeholder="请输入图片描述，字数限制在35字以内">'.$row[4].'</textarea></td>';
...
<script src="../js/carousel/carousel_schoolhelp.js"></script>
</html>
