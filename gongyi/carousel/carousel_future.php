...
$sql="select * from carousel where type=4";
...
<div class="container-fluid">
    ...
    <div class="carouseltitle">
        <span class="glyphicon glyphicon-list"></span><b>展望未来</b><span style="color: #888;font-size: 5px;margin-left: 30px">注意:图片像素请不小于1000x400,大小不超过2M</span>
    </div>
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            for($i=1;$i<=mysqli_num_rows($result);$i++){
                ...
                echo '<td class="hidden-sm hidden-xs"><img src="'.$row[3].'" alt="活动报道轮播图1" width="200px" height="80px" style="border:1px solid red"></td>';
...
<script src="../js/carousel/carousel_future.js"></script>
</html>
